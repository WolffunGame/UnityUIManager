...
{
    [CreateAssetMenu(menuName = "Screen Navigator/Scale Animation Curve Transition Animation")]
    public sealed class ScaleAnimationCurveTransitionAnimationObject : TransitionAnimationObject
    {
        ...
        public async UniTask SetTime(CancellationToken cancellationToken)
        {
            ...
            var scaleTweener = RectTransform.DOScale(_afterScale, _duration).SetDelay(_delay).SetEase(_scaleCurve)
                .From(_beforeScale);
        ...
        public void SetParams(float? duration = null, AnimationCurve scaleCurve = null, Ease? easeType = null, SheetAlignment? beforeAlignment = null,
